    ...
    renderItem(item) {
        ...
        return (
            <TouchableOpacity onPress={() => {
                ...
                this.setState({ UserMessage: item, isModal: true }, () => {
                ...
                <View>
                    <Modal onBackButtonPress={() => { this.setState({ isModal: false }) }} isVisible={this.state.isModal}>
                        <View style={{ height: 350, width: "100%", backgroundColor: "white" }}>
                            ...
                            <Text style={{ marginTop: 20, marginStart: 20, marginEnd: 20, textAlign: "center", fontSize: 16, color: appColor.Gray_Chateau }}>{"Conversation"}</Text>
